...
class TuitionStateService:
    ...
    def load_zipcode_state_mapping(self):
        """Load zipcode to state mapping"""
        # This is a simplified mapping - in production, you'd want a comprehensive zipcode database
        # For now, we'll use common zipcode patterns
        zipcode_patterns = {
